...
type Book struct {
	...
	Price      *Price       `protobuf:"bytes,2,opt,name=price,proto3" json:"price,omitempty"`           // 在同一目录下不需要带package前缀
	AuthorInfo *author.Info `protobuf:"bytes,3,opt,name=authorInfo,proto3" json:"authorInfo,omitempty"` // 不同目录下需要带package前缀
}
...
var file_book_book_proto_rawDesc = []byte{
	...
	0x72, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6d,
	...
	0x6f, 0x52, 0x0a, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x16, 0x5a,
	0x14, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x70, 0x62,
